  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="操作" width="160px">
          <template slot-scope="scope">
            <el-button size="mini" @click="settle(scope.$index, scope.row)">付款</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="销售单明细" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-table-column label="产品数量数量" prop="num" width="100px"></el-table-column>
  ...
  methods: {
    ...
    hdfutrecc() {
      ...
      axios({
        ...
        method: "get",
        params: { page: this.page, payType: this.d, type: 3 }
      }).then(resp => {
        let list = resp.data;
    ...
    axow() {
      axios({
        url: "/api/main/purchase/pomain/show",
        method: "get",
        params: { page: this.page, payType: (this.d = 2), type: 3 }
      }).then(resp => {
        let list = resp.data;
        console.log(list);
    ...
    aso() {
      ...
      axios({
        url: "/api/main/purchase/pomain/show",
        method: "get",
        params: { page: this.page, payType: (this.d = 1), type: 3 }
      }).then(resp => {
        let list = resp.data;
        console.log(list);
